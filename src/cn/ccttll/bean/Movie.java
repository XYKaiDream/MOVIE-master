...
public class Movie {
    ...
    public Movie(int movieId, String movieName, String movieImgUrl) {
        this.movieId = movieId;
        this.movieName = movieName;
        this.movieImgUrl = movieImgUrl;
    }

    public Movie(int movieId, String movieName, String movieImgUrl, String movieScore, String movieDirector, String movieStar, String movieType, String movieArea, String movieYear, String movieSummary, String moviePlayUrl) {
        this.movieId = movieId;
        this.movieName = movieName;
        this.movieImgUrl = movieImgUrl;
